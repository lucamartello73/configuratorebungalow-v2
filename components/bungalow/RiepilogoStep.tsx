      ...
      <div className="bg-white border-2 border-blue-200 rounded-xl p-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-2xl font-bold text-blue-600">{lunghezza} m</p>
          </div>
          <div className="text-center p-4 bg-green-50 rounded-lg">
            <p className="text-sm text-gray-600 mb-1">Larghezza</p>
            <p className="text-2xl font-bold text-green-600">{larghezza} m</p>
          </div>
        ...
        <div className="bg-white border-2 border-orange-200 rounded-xl p-6">
          ...
          {note && (
            <div className="mb-4">
              ...
              <div className="p-4 bg-orange-50 rounded-lg text-sm text-gray-700 whitespace-pre-wrap">
                {note}
              </div>
            </div>
          )}
